...
{
public:
    static const auto s_csWindowWidth = 80;
    static const auto s_csWindowHeight = 80;
    static const auto s_csBufferWidth = 80;
    static const auto s_csBufferHeight = 300;
    ...
    void PrepareGlobalScreenBuffer(const auto viewWidth = s_csWindowWidth,
                                   const auto viewHeight = s_csWindowHeight,
                                   const auto bufferWidth = s_csBufferWidth,
                                   const auto bufferHeight = s_csBufferHeight)
    {
        CONSOLE_INFORMATION& gci = Microsoft::Console::Interactivity::ServiceLocator::LocateGlobals().getConsoleInformation();
        til::coord coordWindowSize;
        coordWindowSize.x = viewWidth;
        coordWindowSize.y = viewHeight;

        til::coord coordScreenBufferSize;
