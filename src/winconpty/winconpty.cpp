...
HRESULT _ResizePseudoConsole(_In_ const PseudoConsole* const pPty, _In_ const til::coord size)
{
...
extern "C" HRESULT WINAPI ConptyCreatePseudoConsole(_In_ til::coord size,
                                                    _In_ HANDLE hInput,
                                                    _In_ HANDLE hOutput,
                                                    _In_ DWORD dwFlags,
                                                    _Out_ HPCON* phPC)
...
extern "C" HRESULT WINAPI ConptyResizePseudoConsole(_In_ HPCON hPC, _In_ til::coord size)
{
