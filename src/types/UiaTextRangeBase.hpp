...
namespace Microsoft::Console::Types
{
    ...
    public:
        ...
        const til::coord GetEndpoint(TextPatternRangeEndpoint endpoint) const noexcept;
        bool SetEndpoint(TextPatternRangeEndpoint endpoint, const til::coord val) noexcept;
    ...
    protected:
        ...
        virtual const til::coord _getScreenFontSize() const noexcept;

        const til::CoordType _getViewportHeight(const til::small_rect viewport) const noexcept;
        const Viewport _getOptimizedBufferSize() const noexcept;
        const til::coord _getDocumentEnd() const;
        ...
        bool _tryMoveToWordStart(const TextBuffer& buffer, const til::coord documentEnd, til::coord& resultingPos) const;

        til::coord _getInclusiveEnd() noexcept;
