...
namespace
{
    ...
    public:
        ...
        std::optional<til::coord> TriggerScrollDelta() const
        {
        ...
        virtual void TriggerRedraw(const til::coord* const){};
        virtual void TriggerRedrawCursor(const til::coord* const){};
        ...
        virtual void TriggerScroll(const til::coord* const delta)
        {
    ...
    private:
        std::optional<til::coord> _triggerScrollDelta;
    };
...
class TerminalCoreUnitTests::ScrollTest final
{
    ...
    static const auto TerminalHistoryLength = 9001;
