...
#pragma warning(suppress : 26430) // This statement sufficiently checks the out parameters. Analyzer cannot find this.
    static HRESULT _CreatePseudoConsoleAndPipes(const til::coord size, const DWORD dwFlags, HANDLE* phInput, HANDLE* phOutput, HPCON* phPC) noexcept
    {
...
#pragma warning(suppress : 26477 26485 26494 26482 26446) // We don't control TraceLoggingWrite
    ...
    try
    {
        ...
        const til::coord dimensions{ _initialCols, _initialRows };
