...
static constexpr til::coord _winToVTCoord(const til::coord coordWinCoordinate) noexcept
{
...
bool TerminalInput::HandleMouse(const til::coord position,
...
std::wstring TerminalInput::_GenerateDefaultSequence(const til::coord position,
                                                     const unsigned int button,
                                                     const bool isHover,
                                                     const short modifierKeyState,
                                                     const short delta)
...
// Return value:
// - The generated sequence. Will be empty if we couldn't generate.
std::wstring TerminalInput::_GenerateUtf8Sequence(const til::coord position,
                                                  const unsigned int button,
                                                  const bool isHover,
                                                  const short modifierKeyState,
                                                  const short delta)
...
std::wstring TerminalInput::_GenerateSGRSequence(const til::coord position,
                                                 const unsigned int button,
                                                 const bool isDown,
                                                 const bool isHover,
                                                 const short modifierKeyState,
