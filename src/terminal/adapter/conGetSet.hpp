...
namespace Microsoft::Console::VirtualTerminal
{
    ...
    public:
        ...
        virtual bool SetConsoleCursorPosition(const til::coord position) = 0;
        ...
        virtual bool PrivateSetScrollingRegion(const til::small_rect& scrollMargins) = 0;
        ...
        virtual bool PrivateFillRegion(const til::coord startPosition,
                                       const size_t fillLength,
                                       const wchar_t fillChar,
                                       const bool standardFillAttrs) = 0;

        virtual bool PrivateScrollRegion(const til::small_rect scrollRect,
