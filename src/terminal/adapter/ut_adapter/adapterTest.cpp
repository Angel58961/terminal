...
public:
    ...
    bool SetConsoleWindowInfo(const bool absolute, const til::small_rect& window) override
    {
    ...
    void _SetMarginsHelper(til::small_rect* rect, SHORT top, SHORT bottom)
    {
        rect->top = top;
        rect->bottom = bottom;
    ...
    til::coord _bufferSize;
    til::small_rect _viewport;
    til::small_rect _expectedConsoleWindow;
    til::coord _cursorPos;
    til::small_rect _expectedScrollRegion;

    bool _cursorVisible = false;

    til::coord _expectedCursorPos;
    ...
    til::coord _expectedScreenBufferSize;
    til::small_rect _expectedScreenBufferViewport{ 0, 0, 0, 0 };
