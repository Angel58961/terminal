...
[[nodiscard]] HRESULT BgfxEngine::Invalidate(const til::small_rect* const /*psrRegion*/) noexcept
{
    return S_OK;
}

[[nodiscard]] HRESULT BgfxEngine::InvalidateCursor(const til::small_rect* const /*psrRegion*/) noexcept
{
    return S_OK;
}
...
[[nodiscard]] HRESULT BgfxEngine::InvalidateSelection(const std::vector<til::small_rect>& /*rectangles*/) noexcept
{
    return S_OK;
}

[[nodiscard]] HRESULT BgfxEngine::InvalidateScroll(const til::coord* const /*pcoordDelta*/) noexcept
{
    return S_OK;
}
...
[[nodiscard]] HRESULT BgfxEngine::PaintSelection(const til::small_rect /*rect*/) noexcept
{
    return S_OK;
}
...
// Return Value:
// - HRESULT S_OK
[[nodiscard]] HRESULT BgfxEngine::UpdateViewport(const til::small_rect /*srNewViewport*/) noexcept
{
    return S_OK;
}
...
[[nodiscard]] HRESULT BgfxEngine::GetFontSize(_Out_ til::coord* const pFontSize) noexcept
{
    *pFontSize = _fontSize;
    return S_OK;
}
