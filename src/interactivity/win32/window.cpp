...
// Return Value:
// <none>
void Window::ChangeViewport(const til::small_rect NewWindow)
{
    ...
    if (WI_IsFlagClear(gci.Flags, CONSOLE_IS_ICONIC))
    {
        ...
        {
            //pNotifier->NotifyConsoleUpdateScrollEvent(viewport.Left() - NewWindow.left, viewport.Top() - NewWindow.top);
        }
        ...
        Tracing::s_TraceWindowViewport(viewport);
...
// Return Value:
// - <none>
void Window::UpdateWindowSize(const til::coord coordSizeInChars)
{
...
void Window::HorizontalScroll(const WORD wScrollCommand, const WORD wAbsoluteChange)
{
    ...
    case SB_BOTTOM:
    {
        NewOrigin.x = sScreenBufferSizeX - viewport.Width();
        break;
    }
...
// Return Value:
// - <none>
void Window::_CalculateWindowRect(const til::coord coordWindowInChars, _Inout_ RECT* const prectWindow) const
{
...
// Return Value:
// - <none>
void Window::s_CalculateWindowRect(const til::coord coordWindowInChars,
                                   const int iDpi,
                                   const til::coord coordFontSize,
                                   const til::coord coordBufferSize,
