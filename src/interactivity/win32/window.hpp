...
namespace Microsoft::Console::Interactivity::Win32
{
    ...
    public:
        ...
        void UpdateWindowSize(const til::coord coordSizeInChars);
    ...
    private:
        ...
        // math helpers
        void _CalculateWindowRect(const til::coord coordWindowInChars,
                                  _Inout_ RECT* const prectWindow) const;
        static void s_CalculateWindowRect(const til::coord coordWindowInChars,
                                          const int iDpi,
