...
{
public:
    TextBufferCellIterator(const TextBuffer& buffer, til::coord pos);
    TextBufferCellIterator(const TextBuffer& buffer, til::coord pos, const Microsoft::Console::Types::Viewport limits);
    ...
    til::coord Pos() const noexcept;

protected:
    void _SetPos(const til::coord newPos);
    void _GenerateView();
    static const ROW* s_GetRow(const TextBuffer& buffer, const til::coord pos);
