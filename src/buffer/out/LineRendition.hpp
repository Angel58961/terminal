...
inline til::small_rect ScreenToBufferLine(const til::small_rect& line, const LineRendition lineRendition)
{
...
inline til::small_rect BufferToScreenLine(const til::small_rect& line, const LineRendition lineRendition)
{
