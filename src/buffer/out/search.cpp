...
std::pair<til::coord, til::coord> Search::GetFoundLocation() const noexcept
{
...
til::coord Search::s_GetInitialAnchor(IUiaData& uiaData, const Direction direction)
{
...
bool Search::_FindNeedleInHaystackAt(const til::coord pos, til::coord& start, til::coord& end) const
{
    start = { 0 };
    end = { 0 };
...
void Search::_IncrementCoord(til::coord& coord) const noexcept
{
...
void Search::_DecrementCoord(til::coord& coord) const noexcept
{
