...
TextBufferCellIterator::TextBufferCellIterator(const TextBuffer& buffer, til::coord pos) :
...
TextBufferCellIterator::TextBufferCellIterator(const TextBuffer& buffer, til::coord pos, const Viewport limits) :
    _buffer(buffer),
    _pos(pos),
...
TextBufferCellIterator& TextBufferCellIterator::operator+=(const ptrdiff_t& movement)
{
    ...
    // Under MSVC writing the individual members of a til::coord generates worse assembly
...
void TextBufferCellIterator::_SetPos(const til::coord newPos)
{
    if (newPos.y != _pos.y)
    {
...
const ROW* TextBufferCellIterator::s_GetRow(const TextBuffer& buffer, const til::coord pos)
{
...
til::coord TextBufferCellIterator::Pos() const noexcept
{
    return _pos;
}
