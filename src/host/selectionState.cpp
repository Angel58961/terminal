...
til::coord Selection::GetSelectionAnchor() const noexcept
{
...
til::small_rect Selection::GetSelectionRectangle() const noexcept
{
...
bool Selection::ShouldAllowMouseDragSelection(const til::coord mousePosition) const noexcept
{
