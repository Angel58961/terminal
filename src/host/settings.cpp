...
til::coord Settings::GetScreenBufferSize() const
{
    return til::wrap_coord(_dwScreenBufferSize);
}
void Settings::SetScreenBufferSize(const til::coord dwScreenBufferSize)
{
    _dwScreenBufferSize = til::unwrap_coord(dwScreenBufferSize);
}

til::coord Settings::GetWindowSize() const
{
    return til::wrap_coord(_dwWindowSize);
}
void Settings::SetWindowSize(const til::coord dwWindowSize)
{
    _dwWindowSize = til::unwrap_coord(dwWindowSize);
}
...
til::coord Settings::GetWindowSizePixels() const
{
    return til::wrap_coord(_dwWindowSizePixels);
}
void Settings::SetWindowSizePixels(const til::coord dwWindowSizePixels)
{
    _dwWindowSizePixels = til::unwrap_coord(dwWindowSizePixels);
}

til::coord Settings::GetWindowOrigin() const
{
    return til::wrap_coord(_dwWindowOrigin);
}
void Settings::SetWindowOrigin(const til::coord dwWindowOrigin)
{
...
til::coord Settings::GetFontSize() const
{
    return til::wrap_coord(_dwFontSize);
}
void Settings::SetFontSize(const til::coord dwFontSize)
{
    _dwFontSize = til::unwrap_coord(dwFontSize);
}
