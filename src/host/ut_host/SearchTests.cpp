...
class SearchTests
{
    ...
    void DoFoundChecks(Search& s, til::coord& coordStartExpected, SHORT lineDelta)
    {
    ...
    TEST_METHOD(ForwardCaseSensitiveJapanese)
    {
        ...
        til::coord coordStartExpected{ 2, 0 };
    ...
    TEST_METHOD(BackwardCaseSensitive)
    {
        ...
        til::coord coordStartExpected{ 0, 3 };
    ...
    TEST_METHOD(BackwardCaseSensitiveJapanese)
    {
        ...
        til::coord coordStartExpected{ 2, 3 };
