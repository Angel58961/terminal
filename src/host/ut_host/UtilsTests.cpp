...
class UtilsTests
{
    ...
    void FillBothCoordsSameRandom(til::coord* pcoordA, til::coord* pcoordB)
    {
        pcoordA->x = pcoordB->x = RandomShort();
        pcoordA->y = pcoordB->y = RandomShort();
    }

    void LogCoordinates(const til::coord coordA, const til::coord coordB)
    {
