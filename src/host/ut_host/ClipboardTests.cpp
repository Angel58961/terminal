...
class ClipboardTests
{
    ...
    std::vector<std::wstring> SetupRetrieveFromBuffers(bool fLineSelection, std::vector<til::small_rect>& selection)
    {
        ...
        selection.clear();
        selection.emplace_back(til::small_rect{ 0, 0, 8, 0 });
        selection.emplace_back(til::small_rect{ 0, 1, 14, 1 });
        selection.emplace_back(til::small_rect{ 0, 2, 14, 2 });
        selection.emplace_back(til::small_rect{ 0, 3, 8, 3 });
...
#pragma prefast(disable : 26006, "Specifically trying to check unterminated strings in this test.")
    TEST_METHOD(TestRetrieveFromBuffer)
    {
        ...
        std::vector<til::small_rect> selection;
