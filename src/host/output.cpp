...
void ScreenBufferSizeChange(const til::coord coordNewSize)
{
...
void ScrollRegion(SCREEN_INFORMATION& screenInfo,
                  const til::small_rect scrollRectGiven,
                  const std::optional<til::small_rect> clipRectGiven,
                  const til::coord destinationOriginGiven,
