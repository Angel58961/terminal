...
bool ConhostInternalGetSet::SetConsoleCursorPosition(const til::coord position)
{
...
bool ConhostInternalGetSet::SetConsoleWindowInfo(const bool absolute, const til::small_rect& window)
{
...
bool ConhostInternalGetSet::PrivateSetScrollingRegion(const til::small_rect& scrollMargins)
{
...
bool ConhostInternalGetSet::PrivateFillRegion(const til::coord startPosition,
...
// Return value:
// - true if successful (see DoSrvPrivateScrollRegion). false otherwise.
bool ConhostInternalGetSet::PrivateScrollRegion(const til::small_rect scrollRect,
