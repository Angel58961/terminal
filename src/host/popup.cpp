...
Popup::Popup(SCREEN_INFORMATION& screenInfo, const til::coord proposedSize) :
...
til::coord Popup::_CalculateSize(const SCREEN_INFORMATION& screenInfo, const til::coord proposedSize)
{
...
til::coord Popup::_CalculateOrigin(const SCREEN_INFORMATION& screenInfo, const til::coord size)
{
...
til::coord Popup::GetCursorPosition() const noexcept
{
