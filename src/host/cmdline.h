...
public:
    ...
    til::coord DeleteFromRightOfCursor(COOKED_READ_DATA& cookedReadData) noexcept;
...
protected:
    ...
    til::coord _deletePromptBeforeCursor(COOKED_READ_DATA& cookedReadData) noexcept;
    til::coord _moveCursorToEndOfPrompt(COOKED_READ_DATA& cookedReadData) noexcept;
    til::coord _moveCursorToStartOfPrompt(COOKED_READ_DATA& cookedReadData) noexcept;
    til::coord _moveCursorLeftByWord(COOKED_READ_DATA& cookedReadData) noexcept;
    til::coord _moveCursorLeft(COOKED_READ_DATA& cookedReadData);
    til::coord _moveCursorRightByWord(COOKED_READ_DATA& cookedReadData) noexcept;
    til::coord _moveCursorRight(COOKED_READ_DATA& cookedReadData) noexcept;
    ...
    til::coord _cycleMatchingCommandHistoryToPrompt(COOKED_READ_DATA& cookedReadData);
...
void SetCurrentCommandLine(COOKED_READ_DATA& cookedReadData, _In_ int Index);
