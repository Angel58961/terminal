...
const til::coord& COOKED_READ_DATA::OriginalCursorPosition() const noexcept
{
    return _originalCursorPosition;
}

til::coord& COOKED_READ_DATA::OriginalCursorPosition() noexcept
{
    return _originalCursorPosition;
}

til::coord& COOKED_READ_DATA::BeforeDialogCursorPosition() noexcept
{
