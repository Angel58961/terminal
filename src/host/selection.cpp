...
// Return Value:
// - Returns a vector where each til::small_rect is one Row worth of the area to be selected.
// - Returns empty vector if no rows are selected.
// - Throws exceptions for out of memory issues
std::vector<til::small_rect> Selection::GetSelectionRects() const
{
    if (!_fSelectionVisible)
    {
        return std::vector<til::small_rect>();
    }
...
// Return Value:
// - <none>
void Selection::InitializeMouseSelection(const til::coord coordBufferPos)
{
...
// Return Value:
// - <none>
void Selection::AdjustSelection(const til::coord coordSelectionStart, const til::coord coordSelectionEnd)
{
...
// Return Value:
// - <none>
void Selection::ExtendSelection(_In_ til::coord coordBufferPos)
{
...
void Selection::ColorSelection(const til::small_rect& srRect, const TextAttribute attr)
{
    CONSOLE_INFORMATION& gci = ServiceLocator::LocateGlobals().getConsoleInformation();
...
void Selection::ColorSelection(const til::coord coordSelectionStart, const til::coord coordSelectionEnd, const TextAttribute attr)
{
...
// Return Value:
// - <none>
void Selection::SelectNewRegion(const til::coord coordStart, const til::coord coordEnd)
{
...
void Selection::SelectAll()
{
    ...
    til::coord coordInputStart;
    til::coord coordInputEnd;
    ...
    til::coord coordNewSelStart;
    til::coord coordNewSelEnd;
