...
namespace Microsoft::Console::Render
{
    ...
    public:
        ...
        void TriggerRedraw(const til::coord* const pcoord) override;
        void TriggerRedrawCursor(const til::coord* const pcoord) override;
        ...
        void TriggerScroll(const til::coord* const pcoordDelta) override;
    ...
    private:
        ...
        void _PaintBufferOutputHelper(_In_ IRenderEngine* const pEngine, TextBufferCellIterator it, const til::coord target, const bool lineWrapped);
        void _PaintBufferOutputGridLineHelper(_In_ IRenderEngine* const pEngine, const TextAttribute textAttribute, const size_t cchLine, const til::coord coordTarget);
        ...
        std::vector<til::small_rect> _GetSelectionRects() const;
        ...
        std::vector<til::small_rect> _previousSelection;
