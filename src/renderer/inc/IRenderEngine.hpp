...
#pragma warning(suppress : 26432) // If you define or delete any default operation in the type '...', define or delete them all (c.21).
        ...
        [[nodiscard]] virtual HRESULT Invalidate(const til::small_rect* psrRegion) noexcept = 0;
        [[nodiscard]] virtual HRESULT InvalidateCursor(const til::small_rect* psrRegion) noexcept = 0;
        [[nodiscard]] virtual HRESULT InvalidateSystem(const RECT* prcDirtyClient) noexcept = 0;
        [[nodiscard]] virtual HRESULT InvalidateSelection(const std::vector<til::small_rect>& rectangles) noexcept = 0;
        [[nodiscard]] virtual HRESULT InvalidateScroll(const til::coord* pcoordDelta) noexcept = 0;
        ...
        [[nodiscard]] virtual HRESULT PaintBufferLine(gsl::span<const Cluster> clusters, til::coord coord, bool fTrimLeft, bool lineWrapped) noexcept = 0;
        [[nodiscard]] virtual HRESULT PaintBufferGridLines(GridLineSet lines, COLORREF color, size_t cchLine, til::coord coordTarget) noexcept = 0;
        [[nodiscard]] virtual HRESULT PaintSelection(til::small_rect rect) noexcept = 0;
        ...
        [[nodiscard]] virtual HRESULT UpdateViewport(til::small_rect srNewViewport) noexcept = 0;
        ...
        [[nodiscard]] virtual HRESULT GetFontSize(_Out_ til::coord* pFontSize) noexcept = 0;
