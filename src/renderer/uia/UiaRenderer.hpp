...
namespace Microsoft::Console::Render
{
    ...
    public:
        ...
        [[nodiscard]] HRESULT PaintBufferLine(gsl::span<const Cluster> const clusters, const til::coord coord, const bool fTrimLeft, const bool lineWrapped) noexcept override;
        [[nodiscard]] HRESULT PaintBufferGridLines(const GridLineSet lines, const COLORREF color, const size_t cchLine, const til::coord coordTarget) noexcept override;
    ...
    private:
        ...
        std::vector<til::small_rect> _prevSelection;
        til::small_rect _prevCursorRegion;
    };
}
