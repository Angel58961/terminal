...
[[nodiscard]] HRESULT WddmConEngine::Invalidate(const til::small_rect* const /*psrRegion*/) noexcept
{
    return S_OK;
}

[[nodiscard]] HRESULT WddmConEngine::InvalidateCursor(const til::small_rect* const /*psrRegion*/) noexcept
{
    return S_OK;
}
...
[[nodiscard]] HRESULT WddmConEngine::InvalidateSelection(const std::vector<til::small_rect>& /*rectangles*/) noexcept
{
    return S_OK;
}

[[nodiscard]] HRESULT WddmConEngine::InvalidateScroll(const til::coord* const /*pcoordDelta*/) noexcept
{
    return S_OK;
}
...
[[nodiscard]] HRESULT WddmConEngine::PaintSelection(const til::small_rect /*rect*/) noexcept
{
    return S_OK;
}
...
// Return Value:
// - HRESULT S_OK
[[nodiscard]] HRESULT WddmConEngine::UpdateViewport(const til::small_rect /*srNewViewport*/) noexcept
{
    return S_OK;
}
...
[[nodiscard]] HRESULT WddmConEngine::GetFontSize(_Out_ til::coord* const pFontSize) noexcept
{
