...
[[nodiscard]] HRESULT GdiEngine::PaintBufferGridLines(const GridLineSet lines, const COLORREF color, const size_t cchLine, const til::coord coordTarget) noexcept
{
    LOG_IF_FAILED(_FlushBufferLines());
...
// Return Value:
// - S_OK or suitable GDI HRESULT error.
[[nodiscard]] HRESULT GdiEngine::PaintSelection(const til::small_rect rect) noexcept
{
    LOG_IF_FAILED(_FlushBufferLines());
